...
public class ControladorDetalle {
    ...
    public void mostrarAlumnos(String nuevoNombre, String nuevaContasena, String nuevaImagen) {
        ...
        try {
            ...
            String sql = "Select * from alumno Where codTutor = " + codTutor;
            resultSet = statement.executeQuery(sql);

            while (resultSet.next()) {
                resultSet.updateString("nombre", nuevoNombre);
                resultSet.updateString("contrasena", nuevaContasena);
                resultSet.updateString("fotoalum", nuevaImagen);

                resultSet.updateRow();
                System.out.println("Fila" + resultSet.getRow());
                System.out.println("codalum: " + resultSet.getInt("codalum")
                        + ", nombrealum: " + resultSet.getString("nombrealum")
                        + ", edadalum: " + resultSet.getString("edadalum")
                        + ", fotoalum: " + resultSet.getString("fotoalum"));
                setFoto(resultSet.getString("fotoalum"));
            }
            conexion.commit();
