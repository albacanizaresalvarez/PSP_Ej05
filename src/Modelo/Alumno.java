...
public class Alumno implements Serializable {
    ...
    public Alumno(Integer codalum, String nombrealum, Integer edadalum, Float notamediaalum, Date fechanacimiento) {
        this.codalum = codalum;
        this.nombrealum = nombrealum;
        this.edadalum = edadalum;
        this.notamediaalum = notamediaalum;
    ...
    public Alumno(int codalum, String nombrealum, int edadalum, float notamediaalum, Date fechanacimiento, String fotoalum) {
          this.codalum = codalum;
        this.nombrealum = nombrealum;
        this.edadalum = edadalum;
        this.fotoalum = fotoalum;
