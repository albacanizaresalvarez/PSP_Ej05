...
public final class JPanelResumen extends javax.swing.JPanel {
    ...
    ControladorCollection CA = new ControladorCollection(); //necesario para mostrar los alumnos de cada tutor
    ...
    public void mostrarDatosTutor() {
        //extraemos los datos del tutor y los mostramos en la vista
